...
res=$(set -o pipefail; ./.docker_tools.py --container motion-optimization-emulator --run "source /root/workspace/devel/setup.bash;/root/workspace/src/nw_riemo_robots/scripts/run_riemo_robot_emulator.sh" | tee >(cat - >&5))
